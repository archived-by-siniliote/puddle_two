...
## DAMA Doctrine Fixture Bundle

.PHONY: doctrine.fixtures.load
doctrine.fixtures.load: ## DoctrineBundle: Load all fixtures.
	$(SYMFONY) doctrine:fixtures:load

.PHONY: doctrine.fixtures.load.nointeract
doctrine.fixtures.load.nointeract: ## DoctrineBundle: Load all fixtures (no interaction).
